...
#   JJVelasco,2.28.2024,Objects & Classes
# ------------------------------------------------------------------------------------------ #
import json
...
class Student(Person):
    """
        ...
        JJVelasco, 2.28.2024, Created class and added properties and private attributes
        """
...
class FileProcessor:
    ...
    JJVelasco, 2.28.2024, Converted code to use student objects instead of dictionaries
    """
    @staticmethod
...
class IO:
    ...
    def output_student_and_course_names(student_data: list[Student]):
        ...
        ChangeLog: (Who, When, What)
        RRoot,1.1.2030,Created function
        JJVelasco, 2.28.2023, Changed to use student objects instead of dictionaries
    ...
    def input_student_data(student_data: list[Student]) -> list[Student]:
        ...
        ChangeLog: (Who, When, What)
        RRoot,1.1.2030,Created function
        JJVelasco, 2.28.2024, Relocated error handling for names to class function
